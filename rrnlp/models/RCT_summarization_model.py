...
class LEDForDataToTextGeneration_MultiLM_Background(LEDPreTrainedModel):
    ...
    def _make_decoders(self, num_decoder_layers_shared):
    ...
    def get_mixture_dist(self, outputs0, outputs1, outputs2, outputs3, outputs4):
    ...
    def forward(
        ...
        return LEDSeq2SeqLMOutput(
            ...
            past_key_values=[decoder_outputs0.past_key_values, \
                            ...
                            decoder_outputs4.past_key_values],
